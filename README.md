...
104 disc images from six sources — five archive.org collections and one direct index. From archive.org: [retro-sample-cds](https://archive.org/details/retro-sample-cds) (27), [Best Service ProSamples](https://archive.org/details/best-service-pro-samples-vol.-12-dance-vocals-akai-1-cd) (29), the [E-MU EIIIX Sound Library](https://archive.org/details/vol.-3-orchestral) (15), [archive-oldschoolscds](https://archive.org/details/archive-oldschoolscds) (15) and the [E-mu E-IV Series Factory Library](https://archive.org/download/e-mu-eiv-series-factory-library) (9); plus [nnty.fun's 90s sample CDs](https://nnty.fun/downloads/other/90ssamplecds/) (9). Seventy-seven flat `.iso`/`.bin`, seventeen compressed `.mdx`, five raw CD images, two `.nrg`, one `.mds`/`.mdf` pair, two audio CDs. The figures below are regenerated by `scripts/benchmark.py` against the current shelf, and re-anchor as discs are added.

| | |
|---|---|
| Discs converted | 97 of 104 |
| Samples | 137 854 |
| Stereo pairs rejoined | 17 369 |
| Audio CD tracks | 161 |
